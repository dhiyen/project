...
<style>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="{{ route('hoa-dons.index') }}">Hóa Đơn</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('nha-cung-caps.index') }}">Nhà Cung Cấp</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('khach-hangs.index') }}">Khách hàng</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('nhan-viens.index') }}">Nhân viên</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('phieu-nhaps.index') }}">Phiếu nhập</a></li>
			...
			<div class="dropdown-menu p-3" aria-labelledby="navbarDropdown">
				...
				<a class="dropdown-item p-2" href="{{ route('doanhthu.report') }}">Tồn kho</a>
				<a class="dropdown-item p-2" href="{{ route('soLuongDon') }}">Nhân viên</a>
				<a class="dropdown-item p-2" href="{{ route('lich-su-mua.index') }}">Lịch sử mua hàng</a>
			</div>
			</li>
        </ul>
    </nav>
