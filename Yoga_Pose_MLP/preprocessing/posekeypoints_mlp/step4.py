...
def preprocess_features(features_root_dir='processed_data/results_posekeypoints_mlp/step3', 
                       output_root_dir='processed_data/results_posekeypoints_mlp/step4'):
    """
...
if __name__ == "__main__":
    ...
    os.makedirs('processed_data/results_posekeypoints_mlp/step4', exist_ok=True)
