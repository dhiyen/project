...
def process_augmentation(keypoints_root_dir='Pose keypoints + MLP/step2',
                         preprocessed_root_dir='Pose keypoints + MLP/step4',
                         output_root_dir='Pose keypoints + MLP/step5',
                         num_augmentations=2):
    """
...
if __name__ == "__main__":
    ...
    os.makedirs('Pose keypoints + MLP/step5', exist_ok=True)
    
    process_augmentation(
        keypoints_root_dir='Pose keypoints + MLP/step2',
        preprocessed_root_dir='Pose keypoints + MLP/step4',
        output_root_dir='Pose keypoints + MLP/step5',
        num_augmentations=2
    )